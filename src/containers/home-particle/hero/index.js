      ...
      <ContentWrapper>
        <ContetnTop>
          <div className="col-3 offset-1">
            ...
            {btn_link && <Button as={Link} to={btn_link} layout={2}>En savoir plus <i className="ti-arrow-right"></i></Button>}
          </div>
        </ContetnTop>
        <ContentBottom>
          <div className="col-4 offset-1">
            <ContentBottomInner>
              <ContentBottomLeft>
                <Text {...descStyle} mb="0">Nous construisons votre solution...</Text>
              </ContentBottomLeft>
              <ContentBottomRight>
                {clients && (
                  <ClientWrap>
