                        ...
                        <Controller>
                            <Scene classToggle="animated" triggerElement="#project-image-1" triggerHook="onCenter">
                                <div className="rn_surface" id="project-image-1">
                                    <Image fluid={cover_image.childImageSharp.fluid} alt="{projectData.client}"/>
                                </div>
                            </Scene>
                        </Controller>
                    </FullwidthBox>
...
export const query = graphql `
    query($id: String!){
        projectsJson(id: {eq: $id}){
            ...
            cover_image {
              childImageSharp {
                fluid(maxWidth: 1760, maxHeight:1400 , quality: 100) {
            ...
            features {
              ...
              image {
                childImageSharp {
                  fluid(maxWidth: 1920, maxHeight: 1480, quality: 100) {
                    ...GatsbyImageSharpFluid_withWebp
                    presentationWidth
                    presentationHeight
                  }
